...
upButton = game.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.W);
downButton = game.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.S);
leftButton = game.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.A);
rightButton = game.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.D);
...
function update(time, delta) {
    ...
    // jump 
    if (upButton.isDown && player.body.onFloor())
    {
